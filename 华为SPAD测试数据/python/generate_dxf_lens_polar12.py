...
M = 29952  # 透镜总共有多少个单元 M*M 透镜总有463*463个结构
unit_size_half = 0.2 #单位微米，单元结构尺寸的一半
filename = 'lens_polar12.dxf'
...
S_temp_1 = sio.loadmat('new_phase_map_far_int.mat')   
R_far = S_temp_1['z'].astype(np.int8)

S_temp_2 = sio.loadmat('new_phase_map_near_int.mat')   
